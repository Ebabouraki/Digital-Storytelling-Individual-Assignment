...
- Παρακάτω τροποποίησα το χρόνο που θέλω να κρατάει η προβολή κάθε πλάνου στη γραμμή χρόνου και τέλος ανάμειξα τις κάμερες έτσι ώστε όλες οι λήψεις να συνεόνται ομολά μεταξύ τους.
